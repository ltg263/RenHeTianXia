...
//        commonNavigator.setAdjustMode(true);
    ...
    public static void initLC(Context mContext, LineChart mLineChart) {
        ...
        mLineChart.setNoDataTextColor(mContext.getResources().getColor(R.color.color_333333));
        // 不需要网格背景
...
//        mLineChart.setMaxHighlightDistance(300);
        ...
        x.setAxisLineColor(mContext.getResources().getColor(R.color.color_333333));
    ...
    private static void setData(Context mContext,LineChart mLineChart) {
        ...
        if (mLineChart.getData() != null &&
            ...
            set1.setCircleColor(mContext.getResources().getColor(R.color.color_333333));
            set1.setHighLightColor(mContext.getResources().getColor(R.color.color_transparent));
